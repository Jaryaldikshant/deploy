    ...
    <>
      ...
      <div className="aboutus-container">
        <div className="text-container">
          <h1 className="catchy-heading">PulsePoint</h1>
      ...
      <div className="why-choose-us-heading">
        <h2>
          Why Choose{" "}
          <span style={{ color: "rgb(59, 157, 135)" }}>PulsePoint</span>{" "}?
        </h2>
      </div>
      <div className="faq-container">
        ...
        <div className="faq-content">
          ...
          >
            <div className="faq-question">What is PulsePoint's mission?</div>
            <div className="faq-answer">
              PulsePoint aims to provide trusted healthcare services with
          ...
          >
            <div className="faq-question">What makes PulsePoint unique?</div>
            <div className="faq-answer">
              PulsePoint combines innovative technology with personalized care,
          ...
          >
            ...
            <div className="faq-answer">
              Yes, PulsePoint provides video call consultations and a 24/7
